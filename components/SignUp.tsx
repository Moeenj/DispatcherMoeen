...
const Sign1 = () => {
  ...
  const handleSignUp = async () => {
    try {
      ...
      console.log(user);
      navigation.navigate('carousel'); // Navigate to the Carousel after successful signup
    } catch (e: any) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.background}>
        ...
        <Pressable style={styles.signupButtun} onPress={handleSignUp}>
